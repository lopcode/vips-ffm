...
public class MagickLogMethod {
    ...
    private static final MethodHandle UP$MH = MagickWand_h.upcallHandle(MagickLogMethod.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(MagickLogMethod.Function fi, Arena arena) {
