...
{
  grep -iE ' (_)?(vips_image|vips_init|vips_nick|vips_source|vips_target|vips_blob|vips_object|vips_block|vips_operation|vips_type|vips_error|vips_version|vips_leak|vips_shut|vips_cache|vips_array|vips_value|vips_enum)[A-Za-z0-9_]*' includes.txt
