 ...
 * }
 */
public class SetWandViewMethod {
    ...
    private static final MethodHandle UP$MH = MagickWand_h.upcallHandle(SetWandViewMethod.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(SetWandViewMethod.Function fi, Arena arena) {
