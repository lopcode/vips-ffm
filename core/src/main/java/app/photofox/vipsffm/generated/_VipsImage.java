...
public class _VipsImage {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        vips_h.C_INT.withName("Xsize"),
        vips_h.C_INT.withName("Ysize"),
        vips_h.C_INT.withName("Bands"),
        vips_h.C_INT.withName("BandFmt"),
        vips_h.C_INT.withName("Coding"),
        vips_h.C_INT.withName("Type"),
        vips_h.C_DOUBLE.withName("Xres"),
        vips_h.C_DOUBLE.withName("Yres"),
        vips_h.C_INT.withName("Xoffset"),
        vips_h.C_INT.withName("Yoffset"),
        vips_h.C_INT.withName("Length"),
        vips_h.C_SHORT.withName("Compression"),
        vips_h.C_SHORT.withName("Level"),
        vips_h.C_INT.withName("Bbits"),
        MemoryLayout.paddingLayout(4),
        vips_h.C_POINTER.withName("time"),
        vips_h.C_POINTER.withName("Hist"),
        vips_h.C_POINTER.withName("filename"),
        vips_h.C_POINTER.withName("data"),
        vips_h.C_INT.withName("kill"),
        vips_h.C_FLOAT.withName("Xres_float"),
        vips_h.C_FLOAT.withName("Yres_float"),
        MemoryLayout.paddingLayout(4),
        vips_h.C_POINTER.withName("mode"),
        vips_h.C_INT.withName("dtype"),
        vips_h.C_INT.withName("fd"),
        vips_h.C_POINTER.withName("baseaddr"),
        vips_h.C_LONG.withName("length"),
        vips_h.C_INT.withName("magic"),
        MemoryLayout.paddingLayout(4),
        vips_h.C_POINTER.withName("start_fn"),
        vips_h.C_POINTER.withName("generate_fn"),
        vips_h.C_POINTER.withName("stop_fn"),
        vips_h.C_POINTER.withName("client1"),
        vips_h.C_POINTER.withName("client2"),
        vips_h.C_POINTER.withName("sslock"),
        vips_h.C_POINTER.withName("regions"),
        vips_h.C_INT.withName("dhint"),
        MemoryLayout.paddingLayout(4),
        vips_h.C_POINTER.withName("meta"),
        vips_h.C_POINTER.withName("meta_traverse"),
        vips_h.C_LONG_LONG.withName("sizeof_header"),
        vips_h.C_POINTER.withName("windows"),
        vips_h.C_POINTER.withName("upstream"),
        vips_h.C_POINTER.withName("downstream"),
        vips_h.C_INT.withName("serial"),
        MemoryLayout.paddingLayout(4),
        vips_h.C_POINTER.withName("history_list"),
        vips_h.C_POINTER.withName("progress_signal"),
        vips_h.C_LONG_LONG.withName("file_length"),
        vips_h.C_INT.withName("hint_set"),
