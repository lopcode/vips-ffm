...
public class CustomStreamSeekCallback {
    ...
    private static final MethodHandle UP$MH = VipsRaw.upcallHandle(CustomStreamSeekCallback.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(CustomStreamSeekCallback.Function fi, Arena arena) {
