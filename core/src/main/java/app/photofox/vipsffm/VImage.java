...
public final class VImage {
  ...
  /// over the process, use `Image.icc_import` instead.
  /// @param args Array of VipsOption to apply to this operation
  ...
  /// over the process, use `Image.icc_export` instead.
  /// @param args Array of VipsOption to apply to this operation
  ...
  /// 
  /// ::: seealso
  ///     `Image.boolean`, `Image.boolean_const1`.
  /// @param boolean1 [VipsOperationBoolean] Boolean to perform
  ...
  ///     `Image.imag`, `Image.cast_uchar`, `Image.msb`.
  ...
  /// 
  /// ::: seealso
  ///     `Image.colourspace_issupported`,
  ///     `Image.guess_interpretation`.
  ...
  /// 
  /// Use `fail-on` to set the type of error that will cause load to fail. By
  /// default, loaders are permissive, that is, `Vips.FailOn.NONE`.
  /// 
  /// 
  /// ::: seealso
  ///     `Image.new_from_file`, `Image.bandfold`.
  /// @param arena The arena that bounds resulting memory allocations during this operation
  /// @param filename Filename to load from
  /// @param args Array of VipsOption to apply to this operation
  ...
  /// 
  /// ::: seealso
  ///     `Image.draw_circle1`, `Image.draw_line`.
  ...
  /// 
  /// ::: seealso
  ///     `Image.draw_line1`, `Image.draw_circle`, `Image.draw_mask`.
  /// @param ink Color for pixels
  ...
  /// `Image.draw_line` subclass to draw an object along a line.
  /// 
  /// `ink` is an array of double containing values to draw.
  /// 
  /// ::: seealso
  ///     `Image.text`, `Image.draw_line`.
  /// @param ink Color for pixels
  ...
  /// in another format.
  /// 
  /// In Google layout mode, edge tiles are expanded to `tile-size` by `tile-size`
  ...
  /// 
  /// You can set the size and overlap of tiles with `tile-size` and `overlap`.
  ...
  /// 
  /// You can use `region-shrink` to control the method for shrinking each 2x2
  ...
  /// 
  /// If you set `skip-blanks` to a value greater than or equal to zero, tiles
  ...
  /// 
  /// ::: seealso
  ///     `Image.dzsave`, `Image.write_to_file`.
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg dirname [VipsOption.String] Directory name to save to
  /// @optionalArg imagename [VipsOption.String] Image name
  /// @optionalArg layout [VipsOption.Enum] [VipsForeignDzLayout] Directory layout
  ...
  /// 
  /// ::: seealso
  ///     `Image.dzsave`, `Image.write_to_target`.
  /// @param target Target to save to
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg dirname [VipsOption.String] Directory name to save to
  /// @optionalArg imagename [VipsOption.String] Image name
  ...
  /// The opposite of `Image.extract_area`: embed `in` within an image of
  ...
  /// 
  /// ::: seealso
  ///     `Image.extract_area`, `Image.insert`.
  ...
  /// 
  /// ::: seealso
  ///     `Image.extract_band`, `Image.smartcrop`.
  ...
  /// `line-art` is set, see below). The absolute difference from `background` is
  ...
  /// 
  /// If the image is entirely background, `Image.find_trim` returns
  ...
  /// (eg. rendered from vector art, perhaps), set `line-art` to disable this
  /// filtering.
  /// 
  ...
  /// 
  /// ::: seealso
  ///     `Image.getpoint`, `Image.extract_area`, `Image.smartcrop`.
  /// @param args Array of VipsOption to apply to this operation
  ...
  /// 
  /// The alpha channel is 0 - `max-alpha`, where `max-alpha` means 100% image
  /// and 0 means 100% background. `background` defaults to zero (black).
  /// 
  /// `max-alpha` has the default value 255, or 65535 for images tagged as
  /// `Vips.Interpretation.RGB16` or `Vips.Interpretation.GREY16`.
  /// 
  ...
  /// `fractalDimension`. The dimension should be between 2 and 3.
  /// 
  /// ::: seealso
  ///     `Image.gaussnoise`, `Image.mask_fractal`.
  /// @param arena The arena that bounds resulting memory allocations during this operation
  /// @param width Image width in pixels
  /// @param height Image height in pixels
  ...
  /// 
  /// ::: seealso
  ///     `Image.identity`, `Image.pow_const1`, `Image.maplut`
  /// @param args Array of VipsOption to apply to this operation
  ...
  /// you on an image.
  /// 
  /// Set `min-ampl` smaller to generate a larger, more accurate mask. Set `sigma`
  ...
  /// it.
  /// 
  /// The result array has an element for each band. If `unpack-complex` is set,
  ...
  /// 
  /// Use `interframe-maxerror` to set the threshold below which pixels are
  /// considered equal.
  /// Pixels which don't change from frame to frame can be made transparent,
  /// improving the compression rate. Default 0.
  /// 
  /// Use `interpalette-maxerror` to set the threshold below which the
  ...
  /// 
  /// ::: seealso
  ///     `Image.gifsave`, `Image.write_to_file`.
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg dither [VipsOption.Double] Amount of dithering
  /// @optionalArg effort [VipsOption.Int] Quantisation effort
  /// @optionalArg bitdepth [VipsOption.Int] Number of bits per pixel
  ...
  /// 
  /// ::: seealso
  ///     `Image.gifsave`, `Image.write_to_target`.
  /// @param target Target to save to
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg dither [VipsOption.Double] Amount of dithering
  /// @optionalArg effort [VipsOption.Int] Quantisation effort
  ...
  /// `Vips.BandFormat.FLOAT`, but if `int-output` is set, the output image
  ...
  /// The opposite of `Image.extract_area`: place `in` within an image of
  ...
  /// this. This image is chopped into a series of tiles, each `tileHeight`
  ...
  /// 
  /// Supplying `tileHeight`, `across` and `down` is not strictly necessary, we
  ...
  /// force the subsampling mode with `subsample-mode`.
  /// 
  ...
  /// 
  /// ::: seealso
  ///     `Image.write_to_file`, `Image.heifload`.
  /// @param filename Filename to save to
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg Q [VipsOption.Int] Q factor
  /// @optionalArg bitdepth [VipsOption.Int] Number of bits per pixel
  ...
  /// 
  /// ::: seealso
  ///     `Image.heifsave`, `Image.write_to_file`.
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg Q [VipsOption.Int] Q factor
  /// @optionalArg bitdepth [VipsOption.Int] Number of bits per pixel
  /// @optionalArg lossless [VipsOption.Boolean] Enable lossless compression
  ...
  /// 
  /// ::: seealso
  ///     `Image.heifsave`, `Image.write_to_target`.
  /// @param target Target to save to
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg Q [VipsOption.Int] Q factor
  /// @optionalArg bitdepth [VipsOption.Int] Number of bits per pixel
  ...
  /// 
  /// ::: seealso
  ///     `Image.hist_find_ndim`, `Image.hist_find_indexed`.
  /// @param args Array of VipsOption to apply to this operation
  ...
  /// 
  /// ::: seealso
  ///     `Image.hist_find`, `Image.labelregions`.
  ...
  /// 
  /// ::: seealso
  ///     `Image.hist_find`, `Image.hist_find_indexed`.
  /// @param args Array of VipsOption to apply to this operation
  ...
  /// 
  /// If `max-slope` is greater than 0, it sets the maximum value for the slope of
  ...
  /// 
  /// ::: seealso
  ///     `Image.maplut`, `Image.hist_find`, `Image.hist_norm`,
  ///     `Image.hist_cum`.
  ...
  /// 
  /// Use `max-radius` and `min-radius` to set the range of radii to search for.
  /// 
  ...
  /// If `output-profile` is not set, use the embedded profile, if any.
  /// If `output-profile` is set, export with that and attach it to the output
  /// image.
  /// 
  /// If `black-point-compensation` is set, LCMS black point compensation is
  /// enabled.
  /// 
  ...
  /// 
  /// 2. Otherwise, if `input-profile` is set, libvips will try to load a
  ...
  /// enabled.
  /// 
  ///    /// `input-profile`: `gchararray`, get the input profile from here
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg pcs [VipsOption.Enum] [VipsPCS] Set Profile Connection Space
  /// @optionalArg intent [VipsOption.Enum] [VipsIntent] Rendering intent
  /// @optionalArg black-point-compensation [VipsOption.Boolean] Enable black point compensation
  ...
  /// field.
  /// 
  /// Use `Image.icc_import` and `Image.icc_export` to do either
  ...
  /// 
  /// ::: seealso
  ///     `Image.join`, `Image.embed`, `Image.extract_area`.
  /// @param sub Sub-image to insert into main image
  ...
  /// [signal`Object`::postclose] signal on `out` is a good place to free.
  /// 
  ///    /// `fail-on`: `FailOn`, types of read error to fail on
  /// @param arena The arena that bounds resulting memory allocations during this operation
  /// @param buffer Buffer to load from
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg page [VipsOption.Int] Load this page from the image
  ...
  /// 
  /// Use `tile-width` and `tile-height` to set the tile size. The default is 512.
  /// 
  /// Chroma subsampling is normally disabled for compatibility. Set
  /// `subsample-mode` to auto to enable chroma subsample for Q < 90. Subsample
  ...
  /// 
  /// ::: seealso
  ///     `Image.write_to_file`, `Image.jp2kload`.
  /// @param filename Filename to save to
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg tile-width [VipsOption.Int] Tile width in pixels
  /// @optionalArg tile-height [VipsOption.Int] Tile height in pixels
  ...
  /// 
  /// ::: seealso
  ///     `Image.jp2ksave`, `Image.write_to_target`.
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg tile-width [VipsOption.Int] Tile width in pixels
  /// @optionalArg tile-height [VipsOption.Int] Tile height in pixels
  /// @optionalArg lossless [VipsOption.Boolean] Enable lossless compression
  ...
  /// `Image.icc_import` to get CIE values from the file.
  /// 
  ...
  /// 
  /// ::: seealso
  ///     `Image.jpegload_buffer`, `Image.autorot`.
  /// @param arena The arena that bounds resulting memory allocations during this operation
  /// @param filename Filename to load from
  /// @param args Array of VipsOption to apply to this operation
  ...
  /// 
  /// If `optimize-coding` is set, the Huffman tables are optimized. This is
  ...
  /// force the subsampling mode with `subsample-mode`.
  /// 
  /// If `trellis-quant` is set and the version of libjpeg supports it
  /// (e.g. mozjpeg >= 3.0), apply trellis quantisation to each 8x8 block.
  /// Reduces file size but increases compression time.
  /// 
  /// If `overshoot-deringing` is set and the version of libjpeg supports it
  ...
  /// white background.
  /// 
  /// If `optimize-scans` is set and the version of libjpeg supports it
  ...
  /// 
  /// If `quant-table` is set and the version of libjpeg supports it
  ...
  /// 
  /// ::: seealso
  ///     `Image.jpegsave_buffer`, `Image.write_to_file`.
  /// @param filename Filename to save to
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg Q [VipsOption.Int] Q factor
  ...
  /// 
  /// ::: seealso
  ///     `Image.jpegsave`, `Image.write_to_file`.
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg Q [VipsOption.Int] Q factor
  /// @optionalArg optimize-coding [VipsOption.Boolean] Compute optimal Huffman coding tables
  /// @optionalArg interlace [VipsOption.Boolean] Generate an interlaced (progressive) jpeg
  ...
  /// 
  /// ::: seealso
  ///     `Image.jpegsave`, `Image.write_to_target`.
  /// @param target Target to save to
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg Q [VipsOption.Int] Q factor
  /// @optionalArg optimize-coding [VipsOption.Boolean] Compute optimal Huffman coding tables
  ...
  /// 
  /// ::: seealso
  ///     `Image.jxlsave`, `Image.write_to_target`.
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg tier [VipsOption.Int] Decode speed tier
  /// @optionalArg distance [VipsOption.Double] Target butteraugli distance
  /// @optionalArg effort [VipsOption.Int] Encoding effort
  ...
  /// 
  /// Use `Image.hist_find_indexed` to (for example) find blob coordinates.
  /// 
  /// 
  /// ::: seealso
  ///     `Image.hist_find_indexed`.
  ...
  /// 
  /// `tile-height` can be used to set the size of the strips that
  ...
  /// 
  /// If `optimize-gif-frames` is set, GIF frames are cropped to the smallest size
  ...
  /// some cases.
  /// 
  /// If `optimize-gif-transparency` is set, pixels that don't change the image
  ...
  /// 
  /// ::: seealso
  ///     `Image.magicksave_buffer`, `Image.magickload`.
  /// @param filename Filename to save to
  /// @param args Array of VipsOption to apply to this operation
  ...
  /// 
  /// ::: seealso
  ///     `Image.magicksave`, `Image.write_to_file`.
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg format [VipsOption.String] Format to save in
  /// @optionalArg quality [VipsOption.Int] Quality to use
  /// @optionalArg optimize-gif-frames [VipsOption.Boolean] Apply GIF frames optimization
  ...
  /// 
  /// ::: seealso
  ///     `Image.hist_find`, `Image.identity`.
  ...
  /// smooth transition
  /// positioned at `frequencyCutoff`, where `frequencyCutoff` is in
  /// range 0 - 1.
  /// 
  ...
  /// variable, smooth transition positioned at `frequencyCutoffX`,
  /// `frequencyCutoffY`, of radius `radius`.
  /// 
  /// The shape of the curve is controlled by
  /// `order` -- higher values give a sharper transition. See Gonzalez and Wintz,
  /// Digital Image Processing, 1987.
  ...
  /// variable,
  /// smooth transition
  /// positioned at `frequencyCutoff` of width `width`, where `frequencyCutoff` is
  /// in the range 0 - 1.
  /// 
  /// The shape of the curve is controlled by
  /// `order` -- higher values give a sharper transition. See Gonzalez and Wintz,
  ...
  /// variable, smooth transition positioned at `frequencyCutoff` of width
  /// `ringwidth`.
  /// 
  /// 
  /// ::: seealso
  ...
  /// 
  /// ::: seealso
  ///     `Image.mask_ideal`, `Image.mask_ideal_ring`,
  ///     `Image.mask_ideal_band`, `Image.mask_butterworth`,
  ///     `Image.mask_butterworth_ring`, `Image.mask_butterworth_band`,
  ///     `Image.mask_gaussian`, `Image.mask_gaussian_ring`,
  ...
  /// sharp cutoff around the point `frequencyCutoffX`, `frequencyCutoffY`,
  /// of size `radius`.
  /// 
  /// 
  /// ::: seealso
  ...
  /// ring positioned at `frequencyCutoff` of width `width`, where
  /// `frequencyCutoff` and `width` are expressed as the range 0 - 1.
  /// 
  /// 
  /// ::: seealso
  ///     `Image.mask_ideal`.
  ...
  /// `out-array`, `x-array` and `y-array`. These values are returned sorted from
  /// largest to smallest.
  /// 
  ...
  /// 
  /// If you set `attach-associated`, then all associated images are attached as
  ...
  /// 
  /// ::: seealso
  ///     `Image.new_from_file`, `Image.magickload`.
  /// @param arena The arena that bounds resulting memory allocations during this operation
  /// @param filename Filename to load from
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg page [VipsOption.Int] First page to load
  ...
  /// 
  /// Use `cell-size` to set the size of the cells from which the image is
  /// constructed. The default is 256 x 256.
  /// 
  /// If `width` and `height` are multiples of `cell-size`, the image will tessellate.
  /// 
  ...
  /// 
  /// ::: seealso
  ///     `Image.pngsave`, `Image.write_to_file`.
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg compression [VipsOption.Int] Compression factor
  /// @optionalArg interlace [VipsOption.Boolean] Interlace image
  /// @optionalArg filter [VipsOption.Int] Libspng row filter flag(s)
  ...
  /// 
  /// ::: seealso
  ///     `Image.pngsave`, `Image.write_to_target`.
  /// @param target Target to save to
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg compression [VipsOption.Int] Compression factor
  /// @optionalArg interlace [VipsOption.Boolean] Interlace image
  ...
  /// `Image.extract_area`) can work directly with images in this format, but
  ...
  /// 
  /// ::: seealso
  ///     `Image.radsave`, `Image.write_to_file`.
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg keep [VipsOption.Int] Which metadata to retain
  /// @optionalArg background [VipsOption.ArrayDouble] Background value
  /// @optionalArg page-height [VipsOption.Int] Set page height for multipage save
  ...
  /// 
  /// ::: seealso
  ///     `Image.new_from_file`, `Image.copy`, `Image.byteswap`.
  /// @param arena The arena that bounds resulting memory allocations during this operation
  /// @param filename Filename to load from
  /// @param width Image width in pixels
  /// @param height Image height in pixels
  ...
  /// 
  /// ::: seealso
  ///     `Image.rawsave`, `Image.write_to_memory`, `Image.write_to_file`.
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg keep [VipsOption.Int] Which metadata to retain
  /// @optionalArg background [VipsOption.ArrayDouble] Background value
  /// @optionalArg page-height [VipsOption.Int] Set page height for multipage save
  ...
  /// 
  /// ::: seealso
  ///     `Image.remainder_const`, `Image.divide`, `Image.round`.
  /// @param right Right-hand image argument
  /// @param args Array of VipsOption to apply to this operation
  ...
  /// The image may have any
  /// non-complex format. For float formats, `Image.remainder_const` calculates
  /// `in` - `c`/// floor (`in` / `c`).
  /// 
  /// If the array of constants has just one element, that constant is used for
  /// all image bands. If the array has more than one element and they have
  ...
  /// 
  /// `tile-height` can be used to set the size of the tiles that
  ...
  /// 
  /// You can use `autofit-dpi` to read out the DPI selected by auto fit.
  /// 
  ...
  /// quick.
  /// 
  /// See `Image.thumbnail_buffer` to thumbnail from a memory buffer, or
  /// `Image.thumbnail_source` to thumbnail from an arbitrary byte source.
  /// 
  ...
  /// interpreted to rotate the image upright. If you set `no-rotate` to `TRUE`,
  ...
  /// 
  /// Use `fail-on` to control the types of error that will cause loading to fail.
  ...
  /// 
  /// One extra optional argument, `option-string`, lets you pass options to the
  /// underlying loader.
  /// 
  /// 
  /// ::: seealso
  ...
  /// 
  /// One extra
  /// optional argument, `option-string`, lets you pass options to the underlying
  /// loader.
  /// 
  /// 
  /// ::: seealso
  ...
  /// 
  /// ::: seealso
  ///     `Image.new_from_file`, `Image.autorot`.
  /// @param arena The arena that bounds resulting memory allocations during this operation
  /// @param filename Filename to load from
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg page [VipsOption.Int] First page to load
  ...
  /// strips. Use `tile-width` and `tile-height` to set the tile size. The defaiult
  /// is 128 by 128.
  /// 
  /// Set `pyramid` to write the image as a set of images, one per page, of
  /// decreasing size. Use `region-shrink` to set how images will be shrunk: by
  ...
  /// 
  /// ::: seealso
  ///     `Image.tiffload`, `Image.write_to_file`.
  /// @param filename Filename to save to
  /// @param args Array of VipsOption to apply to this operation
  ...
  /// 
  /// ::: seealso
  ///     `Image.tiffsave`, `Image.write_to_file`.
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg compression [VipsOption.Enum] [VipsForeignTiffCompression] Compression for this file
  /// @optionalArg Q [VipsOption.Int] Q factor
  /// @optionalArg predictor [VipsOption.Enum] [VipsForeignTiffPredictor] Compression prediction
  ...
  /// 
  /// ::: seealso
  ///     `Image.tiffsave`, `Image.write_to_target`.
  /// @param target Target to save to
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg compression [VipsOption.Enum] [VipsForeignTiffCompression] Compression for this file
  /// @optionalArg Q [VipsOption.Int] Q factor
  ...
  /// This cache is made of up to `max-tiles` tiles (a value of -1
  /// means any number of tiles), and each tile is of size `tile-width`
  /// by `tile-height` pixels.
  /// 
  ...
  /// 
  /// By default, `tile-width` and `tile-height` are 128 pixels, and the operation
  ...
  /// 
  /// The curve is an unsigned 16-bit image with (`in-max` + 1) entries,
  /// each in the range [0, `out-max`].
  /// 
  /// `Lb`, `Lw` are expressed as 0-100, as in LAB colour space. You
  /// specify the scaling for the input and output images with the `in-max` and
  /// `out-max` parameters.
  /// 
  ...
  /// 
  /// Band `alpha-band` (by default the final band) contains the alpha and all
  ...
  /// 
  /// Set `smart-subsample` to enable high quality chroma subsampling.
  /// 
  /// Set `smart-deblock` to enable auto-adjusting of the deblocking filter. This
  /// can improve image quality, especially on low-contrast edges, but encoding
  /// can take significantly longer.
  /// 
  /// Use `alpha-q` to set the quality for the alpha channel in lossy mode. It has
  ...
  /// 
  /// Use `target-size` to set the desired target size in bytes.
  /// 
  /// Use `passes` to set the number of entropy-analysis passes, by default 1,
  /// unless `target-size` is set, in which case the default is 3. It is not
  /// recommended to set `passes` unless you set `target-size`. Doing so will
  /// result in longer encoding times for no benefit.
  /// 
  /// Set `lossless` to use lossless compression, or combine `near-lossless`
  ...
  /// 
  /// For animated webp output, `min-size` will try to optimize for minimum size.
  /// 
  ...
  /// 
  /// ::: seealso
  ///     `Image.webpload`, `Image.write_to_file`.
  /// @param filename Filename to save to
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg Q [VipsOption.Int] Q factor
  /// @optionalArg lossless [VipsOption.Boolean] Enable lossless compression
  ...
  /// 
  /// ::: seealso
  ///     `Image.webpsave`, `Image.write_to_file`.
  /// @param args Array of VipsOption to apply to this operation
  /// @optionalArg Q [VipsOption.Int] Q factor
  /// @optionalArg lossless [VipsOption.Boolean] Enable lossless compression
  /// @optionalArg preset [VipsOption.Enum] [VipsForeignWebpPreset] Preset for lossy compression
